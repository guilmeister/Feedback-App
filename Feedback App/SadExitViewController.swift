...
class SadExitViewController: UIViewController {
    ...
    private func setupView() {
        let path = URL(fileURLWithPath: Bundle.main.path(forResource: "SadEndBackground", ofType: "mp4")!)
