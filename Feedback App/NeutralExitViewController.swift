//
//  NeutralExitViewController.swift
//  Feedback App
//
...
class NeutralExitViewController: UIViewController {
    ...
    private func setupView() {
        let path = URL(fileURLWithPath: Bundle.main.path(forResource: "NeutralEndBackground", ofType: "mp4")!)
